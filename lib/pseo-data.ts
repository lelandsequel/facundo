...
export const locations = [
  {
    ...
    slug: "garden-oaks",
    zipCodes: ["77018"],
    description: "known for its large lots and beautiful trees, making it perfect for spacious custom homes."
  },
  {
    name: "Oak Forest",
    slug: "oak-forest",
    zipCodes: ["77018", "77092"],
    description: "a family-friendly community experiencing a renaissance of new construction and modern living."
  },
  {
    name: "The Heights",
    slug: "the-heights",
    zipCodes: ["77008", "77007"],
    description: "Houston's historic heart, where we specialize in blending modern luxury with historic charm."
  },
  {
    name: "River Oaks",
    slug: "river-oaks",
    zipCodes: ["77019"],
    description: "the epitome of Houston luxury, demanding the highest level of craftsmanship and architectural detail."
  },
  {
    name: "Bellaire",
    slug: "bellaire",
    zipCodes: ["77401"],
    description: "a city within a city, offering excellent quality of life and prime real estate for custom builds."
  },
  {
    name: "Memorial",
    slug: "memorial",
    zipCodes: ["77024"],
    description: "characterized by wooded lots and exclusive estates."
  },
  {
